...
import useUserDetails, { UserDetails } from "../../../hooks/useUserDetails"; // Import hook and type from a separate file
...
const container = {
  ...
  marginVertical: 60,
  marginHorizontal: 10,
  backgroundColor: "rgba(255, 255, 255, 0.8)", // Light neutral background for subtlety
...
const title = {
  ...
  fontWeight: "700" as const, // Modern boldness
  marginBottom: 20,
...
const profilePicture = {
  ...
  marginBottom: 20,
  borderWidth: 2,
  borderColor: "#24a94a", // Vibrant accent for visibility
...
const inputField = {
  ...
  borderWidth: 1,
  borderColor: "#ccc",
  borderRadius: 8, // Modern rounded input
  marginBottom: 12,
  fontSize: 16,
  color: "#000",
...
const infoText = {
  ...
  color: "#444", // Dark neutral for readability
};
...
const loadingText = {
  marginTop: 10,
  fontSize: 14,
  color: "#666", // Subtle grey for loading state
